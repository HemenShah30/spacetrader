...
public class TradeScreenController implements Controller {
     ...
     */
    @FXML
    private void buyGood(Event event) {
     ...
     */
    @FXML
    private void sellGood(Event event) {
        if (MultiPageController.isValidAction(event)) {
            Button btn = (Button) event.getSource();
            String id = btn.getId();
            GoodType type;
    ...
    public void updatePage() {
        ...
        for (GoodType type : GoodType.values()) {
            switch (type) {
            case WATER:
                setLabels(type, player, market, buyWaterBtn, sellWaterBtn, marketWaterLbl,
                        buyPriceWaterLbl, cargoWaterLbl, sellPriceWaterLbl);
                break;
            case FURS:
                setLabels(type, player, market, buyFursBtn, sellFursBtn, marketFurLbl,
                        buyPriceFurLbl, cargoFurLbl, sellPriceFurLbl);
                break;
            case FOOD:
                setLabels(type, player, market, buyFoodBtn, sellFoodBtn, marketFoodLbl,
                        buyPriceFoodLbl, cargoFoodLbl, sellPriceFoodLbl);
                break;
            case ORE:
                setLabels(type, player, market, buyOreBtn, sellOreBtn, marketOreLbl,
                        buyPriceOreLbl, cargoOreLbl, sellPriceOreLbl);
                break;
            case GAMES:
                setLabels(type, player, market, buyGamesBtn, sellGamesBtn, marketGamesLbl,
                        buyPriceGamesLbl, cargoGamesLbl, sellPriceGamesLbl);
                break;
            case MEDICINE:
                setLabels(type, player, market, buyMedicineBtn, sellMedicineBtn, marketMedicineLbl,
                        buyPriceMedicineLbl, cargoMedicineLbl, sellPriceMedicineLbl);
                break;
            case FIREARMS:
                setLabels(type, player, market, buyFirearmsBtn, sellFirearmsBtn, marketFirearmsLbl,
                        buyPriceFirearmsLbl, cargoFirearmsLbl, sellPriceFirearmsLbl);
                break;
            case MACHINES:
                setLabels(type, player, market, buyMachinesBtn, sellMachinesBtn, marketMachinesLbl,
                        buyPriceMachinesLbl, cargoMachinesLbl, sellPriceMachinesLbl);
                break;
            case NARCOTICS:
                setLabels(type, player, market, buyNarcoticsBtn, sellNarcoticsBtn,
                        marketNarcoticsLbl, buyPriceNarcoticsLbl, cargoNarcoticsLbl,
                        sellPriceNarcoticsLbl);
                break;
            case ROBOTS:
                setLabels(type, player, market, buyRobotsBtn, sellRobotsBtn, marketRobotsLbl,
                        buyPriceRobotsLbl, cargoRobotsLbl, sellPriceRobotsLbl);
                break;
            default:
            }
        }
     ...
     * @param buyPriceLbl
     *            The label for the price of the good in the marketplace for buying
     * @param cargoLbl
     *            The label for the quantity of the good the player has in cargo
     * @param sellPriceLbl
     *            The label for the price the user can sell a good to the marketplace
     */
    private void setLabels(GoodType type, Player player, Marketplace market, Button buyButton,
            Button sellButton, Label marketLbl, Label buyPriceLbl, Label cargoLbl,
            Label sellPriceLbl) {
