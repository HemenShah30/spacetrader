...
public class BoundaryBox implements Boundary {
	...
	/**
	 * Constructor for a BoundaryBox taking in the bounding locations and its
	 * sub-regions
	 * 
	 * @param topLeftLoc
	 ...
	 * @return The Boundary at the given location, or null if there's no
	 *         boundary object
	 */
	 ...
	 * @return The Boundary object at the given location, or null if there's no
	 *         object there
	 */
	private Boundary recursiveGetBoundaryObject(Location location,
			Boundary parent) {
