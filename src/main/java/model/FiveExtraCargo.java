...
/**
 * Gadget subclass which represents an additional 5 cargo spaces to the given ship
 * 
...
public class FiveExtraCargo extends Gadget {
    ...
    /**
     * FiveExtraCargo constructor which passes up the price and minimum TechLevel to the Gadget
     * superclass
     */
