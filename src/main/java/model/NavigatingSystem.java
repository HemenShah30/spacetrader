...
/**
 * A NavigatingSystem gadget which improves the flight skill of the player piloting its given ship
 * 
...
public class NavigatingSystem extends Gadget {
    ...
    /**
     * A constructor for the given NavigatingSystem which passes the price and minimum TechLevel up
